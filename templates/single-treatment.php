<?php
	...
	if ( $location_valid ) {
		...
		$location_content .= '<p class="note">Note that ' . get_the_title() . ' may not be <em>performed</em> at every location listed below. The list may include locations where the treatment is prescribed after a patient visit.</p>';
