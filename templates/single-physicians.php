                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php } elseif ($refer_req && $accept_new && $show_portal) { ?>
                            <p>Appointments for new patients are by referral only.</p>
                            <p>Existing patients can either <a href="<?php echo $portal_url; ?>" aria-label="<?php echo $portal_name; ?>" target="_blank" data-categorytitle="Request an Appointment Online | <?php echo $portal_name_attr; ?>">request an appointment online</a> through <?php echo $portal_name; ?>, <a href="<?php echo $appointment_location_url; ?>" aria-label="<?php echo $appointment_location_title; ?>" data-categorytitle="$appointment_location_data">contact the clinic directly</a> or call <?php echo $appointment_phone_name; ?> at <a href="tel:<?php echo $appointment_phone_tel; ?>" class="no-break" data-categorytitle="Main Appointment Line | <?php echo $appointment_phone_name_attr; ?>"><?php echo $appointment_phone_text; ?></a>.</p>
