                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php } elseif (!$location_valid && $refer_req && $accept_new) { ?>
                            <p>Appointments for new patients are by referral only.</p>
                            <p>Existing patients can make an appointment by calling <?php echo $appointment_phone_name; ?> at <a href="tel:<?php echo $appointment_phone_tel; ?>" class="no-break" data-categorytitle="Call main appointment line"><?php echo $appointment_phone_text; ?></a>.</p>
                        ...
                        <?php } elseif (!$location_valid && $accept_new && $show_portal) { ?>
                            <p>New patients can make an appointment by calling <?php echo $appointment_phone_name; ?> at <a href="tel:<?php echo $appointment_phone_tel; ?>" class="no-break" data-categorytitle="Call main appointment line"><?php echo $appointment_phone_text; ?></a>.</p>
                        ...
                        <?php } elseif (!$location_valid && $accept_new) { ?>
                            <p>New and existing patients can make an appointment by calling <?php echo $appointment_phone_name; ?> at <a href="tel:<?php echo $appointment_phone_tel; ?>" class="no-break" data-categorytitle="Call main appointment line"><?php echo $appointment_phone_text; ?></a>.</p>
