                                ...
                                <?php if (get_field('location_phone', $location)) { ?>
                                    <dl data-categorytitle="Telephone Number">
                                        ...
                                        <?php if (get_field('location_new_appointments_phone', $location) && get_field('location_clinic_phone_query', $location)) { ?>
                                            <dd><a href="tel:<?php echo format_phone_dash( get_field('location_new_appointments_phone', $location) ); ?>" class="icon-phone"><?php echo format_phone_us( get_field('location_new_appointments_phone', $location) ); ?></a><?php echo $location_appointment_phone_query ? '<br/><span class="subtitle">New Patients</span>' : '<br/><span class="subtitle">New and Returning Patients</span>'; ?></dd>
                                            <?php if (get_field('location_return_appointments_phone', $location) && $location_appointment_phone_query) { ?>
