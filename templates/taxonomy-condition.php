						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									...
									<div class="more">
										<button class="loadmore btn btn-primary stretched-link" data-type="taxonomy" data-tax="condition" data-slug="<?php echo get_queried_object()->slug; ?>" data-ppp="<?php echo $postsPerPage; ?>" data-postcount="<?php echo $doctorQuery->found_posts; ?>" aria-label="Load more physicians">Load More</button>
									</div>
									<?php } ?>
								</div>
							</div>
