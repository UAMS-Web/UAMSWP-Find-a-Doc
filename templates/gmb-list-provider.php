    ...
    if ( $query->have_posts() ) : ?>
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td data-gmb-column="Store code" class="no-break">regis-l-renard</td>
                        <td data-gmb-column="Business name" class="no-break">UAMS - Regis L. Renard, M.D.</td>
                        <td data-gmb-column="Address line 1" class="no-break">4110 Outpatient Circle</td>
                        <td data-gmb-column="Address line 2" class="no-break"></td>
                        <td data-gmb-column="Address line 3" class="no-break"></td>
                        <td data-gmb-column="Address line 4" class="no-break"></td>
                        <td data-gmb-column="Address line 5" class="no-break"></td>
                        <td data-gmb-column="Sub-locality" class="no-break"></td>
                        <td data-gmb-column="Locality" class="no-break">Little Rock</td>
                        <td data-gmb-column="Administrative area" class="no-break">AR</td>
                        <td data-gmb-column="Country / Region" class="no-break">US</td>
                        <td data-gmb-column="Postal code" class="no-break">72205</td>
                        <td data-gmb-column="Primary phone" class="no-break">(501) 686-6067</td>
                        <td data-gmb-column="Additional phones" class="no-break"></td>
                        <td data-gmb-column="Website" class="no-break">https://uamshealth.com/provider/regis-l-renard/?utm_source=google&amp;utm_medium=gmb&amp;utm_campaign=clinical&amp;utm_term=provider&amp;utm_content=profile</td>
                        <td data-gmb-column="Primary category" class="no-break">Orthopedic surgeon</td>
                        <td data-gmb-column="Additional categories" class="no-break">Doctor</td>
                        <td data-gmb-column="Sunday hours" class="no-break"></td>
                        <td data-gmb-column="Monday hours" class="no-break">08:00-16:30</td>
                        <td data-gmb-column="Tuesday hours" class="no-break">08:00-16:30</td>
                        <td data-gmb-column="Wednesday hours" class="no-break">08:00-16:30</td>
                        <td data-gmb-column="Thursday hours" class="no-break">08:00-16:30</td>
                        <td data-gmb-column="Friday hours" class="no-break">08:00-16:30</td>
                        <td data-gmb-column="Saturday hours" class="no-break"></td>
                        <td data-gmb-column="Special hours" class="no-break"></td>
                        <td data-gmb-column="From the business"><span style="display: block; width: 19.6875em"></span>Dr. Renard is a board certified, orthopaedic traumatologist. He specializes in the care of peri-articular, pelvic and acetabular fractures; treatment of post-traumatic complications including nonunions, malunions and osteomyelitis; limb salvage; deformity correction; joint preservation and post-traumatic adult reconstruction of the hip, knee and ankle.</td>
                        <td data-gmb-column="Opening date" class="no-break"></td>
                        <td data-gmb-column="Labels"></td>
                        <td data-gmb-column="AdWords location extensions phone" class="no-break"></td>
                        <td data-gmb-column="Accessibility: Wheelchair accessible elevator (has_wheelchair_accessible_elevator)" class="no-break">Yes</td>
                        <td data-gmb-column="Accessibility: Wheelchair accessible entrance (has_wheelchair_accessible_entrance)" class="no-break">Yes</td>
                        <td data-gmb-column="Accessibility: Wheelchair accessible parking lot (has_wheelchair_accessible_parking)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Accessibility: Wheelchair accessible restroom (has_wheelchair_accessible_restroom)" class="no-break">Yes</td>
                        <td data-gmb-column="Amenities: Restroom (has_restroom)" class="no-break">Yes</td>
                        <td data-gmb-column="Amenities: Wi-Fi (wi_fi)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="From the business: Identifies as Black-owned (is_black_owned)" class="no-break"></td>
                        <td data-gmb-column="From the business: Identifies as veteran-led (is_owned_by_veterans)" class="no-break"></td>
                        <td data-gmb-column="From the business: Identifies as women-led (is_owned_by_women)" class="no-break"></td>
                        <td data-gmb-column="Health &amp; safety: Appointment required (requires_appointments)" class="no-break"></td>
                        <td data-gmb-column="Health &amp; safety: Mask required (requires_masks_customers)" class="no-break">Yes</td>
                        <td data-gmb-column="Health &amp; safety: Safety dividers at checkout (has_plexiglass_at_checkout)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Health &amp; safety: Staff get temperature checks (requires_temperature_check_staff)" class="no-break">Yes</td>
                        <td data-gmb-column="Health &amp; safety: Staff required to disinfect surfaces between visits (is_sanitizing_between_customers)" class="no-break">Yes</td>
                        <td data-gmb-column="Health &amp; safety: Staff wear masks (requires_masks_staff)" class="no-break">Yes</td>
                        <td data-gmb-column="Health &amp; safety: Temperature check required (requires_temperature_check_customers)" class="no-break">Yes</td>
                        <td data-gmb-column="Offerings: Passport photos (has_onsite_passport_photos)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Cash-only (requires_cash_only)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Checks (pay_check)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): American Express (american_express)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): China Union Pay (china_union_pay)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): Diners Club (diners_club)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): Discover (discover)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): JCB (jcb)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): MasterCard (mastercard)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Credit cards (pay_credit_card_types_accepted): VISA (visa)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: Debit cards (pay_debit_card)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Payments: NFC mobile payments (pay_mobile_nfc)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Place page URLs: Appointment links (url_appointment)" class="no-break">https://uamshealth.com/provider/regis-l-renard/?utm_source=google&amp;utm_medium=gmb&amp;utm_campaign=clinical&amp;utm_term=provider&amp;utm_content=appointment-links</td>
                        <td data-gmb-column="Place page URLs: COVID-19 info link (url_covid_19_info_page)" class="no-break">https://uamshealth.com/coronavirus/?utm_source=google&amp;utm_medium=gmb&amp;utm_campaign=clinical&amp;utm_term=provider&amp;utm_content=covid-19-info-link</td>
                        <td data-gmb-column="Place page URLs: Menu link (url_menu)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Place page URLs: Virtual care link (url_facility_telemedicine_page)" class="no-break"></td>
                        <td data-gmb-column="Planning: LGBTQ friendly (welcomes_lgbtq)" class="no-break"></td>
                        <td data-gmb-column="Planning: Transgender safespace (is_transgender_safespace)" class="no-break"></td>
                        <td data-gmb-column="Service options: Curbside pickup (has_curbside_pickup)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Service options: Delivery (has_delivery)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Service options: Drive-through (has_drive_through)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Service options: In-store pickup (has_in_store_pickup)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Service options: In-store shopping (has_in_store_shopping)" class="no-break">[NOT APPLICABLE]</td>
                        <td data-gmb-column="Service options: Online care (has_video_visits)" class="no-break"></td>
                        <td data-gmb-column="Service options: Same-day delivery (has_delivery_same_day)" class="no-break">[NOT APPLICABLE]</td>
                    </tr>
                ...
                while( $query->have_posts() ) : $query->the_post();
                    ...
                    if ( $location_valid ) {
                                ...
                                foreach( $locations as $location ) {
                                    if ( 2 > $l ){
                                        if ( get_post_status ( $location ) == 'publish' ) {
                                            ...
                                            $primary_appointment_telemed = get_field( 'location_telemed_query', $location );
                                            $l++;
                                        }
                                    }
                                } // endforeach
                        ...
                        // Value based on the relevant location profile
                            ...
                            echo $primary_appointment_telemed ? 'Yes' : '';
                            echo '</td>';
