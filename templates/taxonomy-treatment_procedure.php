			...
			?>
				<section class="uams-module bg-auto" id="doctors">
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
							<h2 class="module-title">Physicians Performing <?php echo single_cat_title( '', false ); ?></h2>
							<p class="note">Note that every condition listed above may not be treated by each doctor listed below. Review each doctor for availability.</p>	
								...
								<div class="more">
									<button class="loadmore btn btn-primary" data-type="taxonomy" data-tax="treatment_procedure" data-slug="<?php echo get_queried_object()->slug; ?>" data-ppp="<?php echo $postsPerPage; ?>" data-postcount="<?php echo $doctorQuery->found_posts; ?>" aria-label="Load more physicians">Load More</button>
								</div>
								<?php } ?>
							</div>
						</div>
