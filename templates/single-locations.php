...
<?php 
	...
	$jump_link_count = 0;
		...
		$location_descendant_query_function = uamswp_fad_location_descendant_query( $current_id, $location_descendants, $jump_link_count );
			...
			$jump_link_count = $location_descendant_query_function['jump_link_count']; // int
