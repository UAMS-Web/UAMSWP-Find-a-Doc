...
$fpage_name = $expertise_descendant_plural_name; // Name of ontology item type represented by this fake subpage
$fpage_name_attr = uamswp_attr_conversion($fpage_name);
$fpage_title = $expertise_descendant_fpage_title_expertise; // Fake subpage page title
...
$fpage_intro = $expertise_descendant_fpage_intro_expertise; // Fake subpage intro text
...
$excerpt = $expertise_descendant_fpage_short_desc_expertise;
...
// Construct page content
	...
	// Display ontology page content
		...
		$uamswp_fad_section_expertise_args = array(
			'expertise_descendants'				=> $expertise_descendants, // Value of the related (or descendant) areas of expertise input (or list of this area of expertise item's descendant items)
			...
			'expertise_descendant_section_show'	=> $expertise_descendant_section_show, // Query for whether to show the area of expertise section
		...
		add_action( 'genesis_entry_content', function() use ($uamswp_fad_section_expertise_args) {
			uamswp_fad_section_expertise(
				$uamswp_fad_section_expertise_args['expertise_descendants'], // int[] // Value of the related (or descendant) areas of expertise input (or list of this area of expertise item's descendant items)
				...
				$uamswp_fad_section_expertise_args['expertise_descendant_section_show'], // bool (optional) // Query for whether to show the area of expertise section
