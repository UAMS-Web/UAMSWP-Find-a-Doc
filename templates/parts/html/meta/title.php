 ...
 * 
 * Optional vars:
 * 	$meta_title_base_addition // string (default: $page_title_attr) // Word or phrase to use to form base meta title // Defaults to $page_title_attr
 * 	$meta_title_base_order // array (default: array()) // Pre-defined array for name order of base meta title // Expects one value but will accommodate any number of values
 * 	$meta_title_enhanced_addition // string (default: '') // Word or phrase to inject into base meta title to form enhanced meta title level 1
 * 	$meta_title_enhanced_order // array (default: array()) // Pre-defined array for name order of enhanced meta title level 1 // Expects two values but will accommodate any number of values
 * 	$meta_title_enhanced_x2_addition // string (default: '') // Second word or phrase to inject into base meta title to form enhanced meta title level 2
 * 	$meta_title_enhanced_x2_order // array (default: array()) // Pre-defined array for name order of enhanced meta title level 2 // Expects three values but will accommodate any number of values
 * 	$meta_title_enhanced_x3_addition // string (default: '') // Third word or phrase to inject into base meta title to form enhanced meta title level 3
 * 	$meta_title_enhanced_x3_order // array (default: array()) // Pre-defined array for name order of enhanced meta title level 3 // Expects four values but will accommodate any number of values
 */
