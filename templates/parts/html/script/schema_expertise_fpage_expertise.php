...
// area of expertise related expertise subpage-specific schema
...
// Integrate into array with '@type' => 'MedicalWebPage' in $schema_base['@graph'] related to the area of expertise
	...
	$schema_graph_MedicalWebPage = array(
		...
		array(
			'mentions' => array(
				array( // Populate values for related expertise items, repeating as necessary
					'@type' => 'MedicalEntity',
					'foo' => 'bar',
					'url' => array(
						'@id' => 'https://uamshealth.com/expertise/foo/#URL', // Replace URL up to the hash with relevant URL
						'https://uamshealth.com/expertise/foo/' // Replace URL up to the hash with relevant URL
					)
				)
			),
