...
$clinical_resource_profile_fields_vars = isset($clinical_resource_profile_fields_vars) ? $clinical_resource_profile_fields_vars : uamswp_fad_clinical_resource_profile_fields( $page_id );
