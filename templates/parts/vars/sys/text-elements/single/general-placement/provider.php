...
// Call the function
	...
	$fpage_text_provider_general_vars = ( isset($fpage_text_provider_general_vars) && !empty($fpage_text_provider_general_vars) ) ? $fpage_text_provider_general_vars : uamswp_fad_fpage_text_provider_general(
		$page_id, // int
...
// Create a variable for each item in the array
	...
	foreach ( $fpage_text_provider_general_vars as $key => $value ) {
