...
// Call the function
	...
	$fpage_text_condition_treatment_general_vars = ( isset($fpage_text_condition_treatment_general_vars) && !empty($fpage_text_condition_treatment_general_vars) ) ? $fpage_text_condition_treatment_general_vars : uamswp_fad_fpage_text_condition_treatment_general(
		$page_id, // int
