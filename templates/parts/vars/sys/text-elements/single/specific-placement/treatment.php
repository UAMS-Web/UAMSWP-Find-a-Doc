<?php
/*
 * Template Name: System settings for text elements in a treatment subsection (or 
 * profile)
 * 
 * Description: A template part that defines a series of variables related to the 
 * text elements in a treatment subsection (or profile). This includes the titles 
