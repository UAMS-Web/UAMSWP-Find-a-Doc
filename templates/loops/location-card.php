...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p class="card-text"><?php echo get_field('location_address_1', $id ); ?><br/>
            ...
            <?php if ($map) { ?>
            <a class="btn btn-outline-primary" href="https://www.google.com/maps/dir/Current+Location/<?php echo $map['lat'] ?>,<?php echo $map['lng'] ?>" target="_blank" aria-label="Get Directions</a>
            <?php } ?>
        </p>
    </div><!-- .card-body -->
</div><!-- .card --> 