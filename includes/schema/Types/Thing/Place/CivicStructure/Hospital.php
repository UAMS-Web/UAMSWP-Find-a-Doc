...
// Hospital
	...
	function uamswp_fad_schema_hospital(
		...
		// Check/define variables
			...
			// Inherited properties from LocalBusiness (Thing > Organization > LocalBusiness)
			// Inherited properties from LocalBusiness (Thing > Place > LocalBusiness)
			...
			// Inherited properties from EmergencyService (Thing > Organization > LocalBusiness > EmergencyService)
			// Inherited properties from EmergencyService (Thing > Place > LocalBusiness > EmergencyService)

				// Do nothing (no property vars)

			// Properties from Hospital (Thing > Place > CivicStructure > Hospital)
			// Properties from Hospital (Thing > Organization > LocalBusiness > EmergencyService > Hospital)
			// Properties from Hospital (Thing > Organization > MedicalOrganization > Hospital)
			// Properties from Hospital (Thing > Place > LocalBusiness > EmergencyService > Hospital)

				$availableService = ( isset($availableService) && !empty($availableService) ) ? $availableService : '';
				$healthcareReportingData = ( isset($healthcareReportingData) && !empty($healthcareReportingData) ) ? $healthcareReportingData : '';
				$medicalSpecialty = ( isset($medicalSpecialty) && !empty($medicalSpecialty) ) ? $medicalSpecialty : '';
		...
		// Add values to the schema array
			...
			// Inherited properties
				...
				$schema = uamswp_fad_schema_emergencyservice(
					$schema, // array // Main schema array
					// EmergencyService (no property vars)
					// LocalBusiness
						$currenciesAccepted, // currenciesAccepted
