...
// SurgicalProcedure
	...
	function uamswp_fad_schema_surgicalprocedure(
		...
		// SurgicalProcedure (no property vars)
		// MedicalProcedure
		...
		// Check/define variables
			...
			// Properties from SurgicalProcedure (Thing > MedicalEntity > MedicalProcedure > SurgicalProcedure)
		...
		// Add values to the schema array
			...
			// Properties from SurgicalProcedure
