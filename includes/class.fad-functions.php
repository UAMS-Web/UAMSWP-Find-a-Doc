...
function uamswp_fad_section_clinical_resource() {
	// Bring in variables from outside of the function
		...
		global $clinical_resource_section_show_header; // Query whether to display the section header // bool (default: true)
		...
		global $clinical_resource_section_more_show; // Query whether to show the section that links to more items // bool (default: true)
		...
		global $clinical_resource_section_collapse_list; // Query whether to collapse the list of locations in the locations section // bool (default: false)
		...
		// Defined on the template or in a function such as uamswp_fad_clinical_resource_query()
		global $clinical_resource_section_show; // bool
		global $clinical_resource_query; // array
		global $clinical_resource_count; // integer
...
// Construct conditions section for display on a page
function uamswp_fad_section_condition() {
	// Bring in variables from outside of the function
		...
		global $condition_section_show_header; // Query whether to display the section header // bool (default: true)
