...
function uamswp_provider_ajax_filter_shortcode( $atts ) {
	...
	<div class="ajax-filter" id="provider-ajax-filter">
		...
		<p class="ajax-filter-message" id="provider-ajax-filter-message">The providers displayed below have been filtered by region, based on your previous&nbsp;selections.</p>
		<?php } ?>
    </div>
	<hr />
	<?php
...
function uamswp_location_ajax_filter_shortcode( $atts ) {
	...
	<div class="ajax-filter" id="location-ajax-filter">
		...
		<?php if( isset($_COOKIE['wp_filter_region']) ) { ?>
		<p class="ajax-filter-message" id="location-ajax-filter-message">The locations displayed below have been filtered by region, based on your previous&nbsp;selections.</p>
		<?php } ?>
    </div>
	<hr />
